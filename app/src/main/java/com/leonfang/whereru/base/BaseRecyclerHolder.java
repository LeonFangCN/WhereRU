...
public class BaseRecyclerHolder extends RecyclerView.ViewHolder {
    ...
    public BaseRecyclerHolder setImageView(String avatar, int defaultRes, int viewId) {
        ...
        Logger.e(getClass(),avatar);
        Glide.with(WhereRUApplication.INSTANCE()).load(avatar).asBitmap().placeholder(defaultRes).error(defaultRes).into(new CircleImageViewTarget(iv));
        return this;
    }
}