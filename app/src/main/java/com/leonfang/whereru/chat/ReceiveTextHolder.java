...
public class ReceiveTextHolder extends BaseViewHolder {
    ...
    public void bindData(Object o) {
        ...
        final BmobIMConversation bmobIMConversation = message.getBmobIMConversation();
        Glide.with(context).load(bmobIMConversation != null ? bmobIMConversation.getConversationIcon() : null).error(R.drawable.personal_icon_default_avatar).into(iv_avatar);
