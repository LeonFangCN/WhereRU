...
public class SendVideoHolder extends BaseViewHolder {
    ...
    public void bindData(Object o) {
        ...
        if (!content.isEmpty() && content.indexOf("&") != -1) {
            remoteUrl = content.substring(content.indexOf("&") + 1);
            localPath = content.substring(0, content.indexOf("&"));
            file = new File(localPath);
        }

        Glide.with(context).load(localPath).into(iv_picture);
...
// iv_picture,null);
        ...
        iv_picture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.FILE_PATH, localPath);
