...
public class NewFriendAdapter extends BaseRecyclerAdapter<NewFriend> {
    ...
    public void bindView(final BaseRecyclerHolder holder, final NewFriend add, int position) {
        holder.setImageView(add == null ? null : add.getAvatar(), R.drawable.personal_icon_default_avatar, R.id.iv_recent_avatar);
        Logger.e(getClass(),add == null ? "null" : add.getAvatar());
        ...
        Logger.i(NewFriendAdapter.class,"bindData:"+status+","+add.getUid()+","+add.getTime());
    ...
    private void sendAgreeAddFriendMessage(final NewFriend add,final SaveListener listener){
        Logger.e(getClass(),"sendAgreeAddFriendMessage");
